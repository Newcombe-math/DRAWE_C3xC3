                            ...
                            for rrrrrrrr=rrrrrrr+1:zn
                                ...
                                for rrrrrrrrr=rrrrrrrr+1:zn
                                    ...
                                    for rrrrrrrrrr=rrrrrrrrr+1:zn
                                        ...
                                        %4 cycles
                                        check=0;
                                        if (a==3 && b==6) || (c==3 && d==6) || (e==3 && f==6) || (g==3 && h==6) || (i==3 && j==6) || (k==3 && l==6) || (m==3 && n==6) || (o==3 && p==6) || (q==3 && r==6) || (s==3 && t==6)
                                            check=1;
                                        end
                                        if (a==1 && b==9) || (c==1 && d==9) || (e==1 && f==9) || (g==1 && h==9) || (i==1 && j==9) || (k==1 && l==9) || (m==1 && n==9) || (o==1 && p==9) || (q==1 && r==9) || (s==1 && t==9)
                                            check=1;
                                        end
                                        if check==0
                                            continue
                                        ...
                                        check=0;
                                        if (a==1 && b==11) || (c==1 && d==11) || (e==1 && f==11) || (g==1 && h==11) || (i==1 && j==11) || (k==1 && l==11) || (m==1 && n==11) || (o==1 && p==11) || (q==1 && r==11) || (s==1 && t==11)
                                            check=1;
                                        end
                                        if (a==4 && b==7) || (c==4 && d==7) || (e==4 && f==7) || (g==4 && h==7) || (i==4 && j==7) || (k==4 && l==7) || (m==4 && n==7) || (o==4 && p==7) || (q==4 && r==7) || (s==4 && t==7)
                                            check=1;
                                        end
                                        if check==0
                                            continue
                                        ...
                                        check=0;
                                        if (a==3 && b==14) || (c==3 && d==14) || (e==3 && f==14) || (g==3 && h==14) || (i==3 && j==14) || (k==3 && l==14) || (m==3 && n==14) || (o==3 && p==14) || (q==3 && r==14) || (s==3 && t==14)
                                            check=1;
                                        end
                                        if (a==2 && b==10) || (c==2 && d==10) || (e==2 && f==10) || (g==2 && h==10) || (i==2 && j==10) || (k==2 && l==10) || (m==2 && n==10) || (o==2 && p==10) || (q==2 && r==10) || (s==2 && t==10)
                                            check=1;
                                        end
                                        if check==0
                                            continue
                                        ...
                                        check=0;
                                        if (a==6 && b==14) || (c==6 && d==14) || (e==6 && f==14) || (g==6 && h==14) || (i==6 && j==14) || (k==6 && l==14) || (m==6 && n==14) || (o==6 && p==14) || (q==6 && r==14) || (s==6 && t==14)
                                            check=1;
                                        end
                                        if (a==5 && b==12) || (c==5 && d==12) || (e==5 && f==12) || (g==5 && h==12) || (i==5 && j==12) || (k==5 && l==12) || (m==5 && n==12) || (o==5 && p==12) || (q==5 && r==12) || (s==5 && t==12)
                                            check=1;
                                        end
                                        if check==0
                                            continue
                                        ...
                                        %bowties
                                        check=0;
                                        if ((a==4 || a==3 || a==8) && (b==2 || b==5 || b==1))... 
                                            || ((c==4 || c==3 || c==8) && (d==2 || d==5 || d==1))... 
                                            || ((e==4 || e==3 || e==8) && (f==2 || f==5 || f==1))... 
                                            || ((g==4 || g==3 || g==8) && (h==2 || h==5 || h==1))... 
                                            || ((i==4 || i==3 || i==8) && (j==2 || j==5 || j==1))... 
                                            || ((k==4 || k==3 || k==8) && (l==2 || l==5 || l==1))... 
                                            || ((m==4 || m==3 || m==8) && (n==2 || n==5 || n==1))... 
                                            || ((o==4 || o==3 || o==8) && (p==2 || p==5 || p==1))... 
                                            || ((q==4 || q==3 || q==8) && (r==2 || r==5 || r==1))...
                                            || ((s==4 || s==3 || s==8) && (t==2 || t==5 || t==1))
                                            check=1;
                                        end
                                        if ((b==4 || b==3 || b==8) && (a==2 || a==5 || a==1))... 
                                            || ((d==4 || d==3 || d==8) && (c==2 || c==5 || c==1))... 
                                            || ((f==4 || f==3 || f==8) && (e==2 || e==5 || e==1))... 
                                            || ((h==4 || h==3 || h==8) && (g==2 || g==5 || g==1))... 
                                            || ((j==4 || j==3 || j==8) && (i==2 || i==5 || i==1))... 
                                            || ((l==4 || l==3 || l==8) && (k==2 || k==5 || k==1))... 
                                            || ((n==4 || n==3 || n==8) && (m==2 || m==5 || m==1))... 
                                            || ((p==4 || p==3 || p==8) && (o==2 || o==5 || o==1))... 
                                            || ((r==4 || r==3 || r==8) && (q==2 || q==5 || q==1))...
                                            || ((t==4 || t==3 || t==8) && (s==2 || s==5 || s==1))
                                            check=1;
                                        end
                                        if check==0
                                            continue
                                        ...
                                        if checkbad==0
                                            ...
                                            possible{possiblenum,1}=[a,b;c,d;e,f;g,h;i,j;k,l;m,n;o,p;q,r;s,t];
%                                             end
                                         end
                                    end
                                end
